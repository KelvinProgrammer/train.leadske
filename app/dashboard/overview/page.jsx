    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="hidden sm:flex px-4 py-2 bg-white text-neutral-900 rounded-lg text-sm font-medium hover:bg-neutral-200 transition-colors"
        >
          Browse Courses
        </Link>
      </div>
            ...
            {enrolledCourses.map((course) => (
              <div key={course.id} className="bg-neutral-950 border border-neutral-800 rounded-lg p-4">
                <div className="flex items-start gap-4">
                  ...
                  <button className="hidden sm:block px-3 py-1.5 bg-white text-neutral-900 rounded-lg text-sm font-medium hover:bg-neutral-200 transition-colors shrink-0">
                    Continue
                  </button>
                </div>
              </div>
